...
public class OwlHelper {
    ...
    public static void save(Model model, String outFile) {
        try {
            RDFDataMgr.write(new FileOutputStream(outFile), model, RDFFormat.RDFXML);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
     ...
     * @param owlFile
     */
    public static OntModel readOwlToOntModel(String owlFile) {
    ...
    /**
     * linking Model with an owl file
     * 
     * @param owlFile
     */
    public static Model readOwl(String owlFile) {
        Model model;
    ...
    public static void main(String[] args) {
        ...
        OntModel model = OwlHelper.readOwlToOntModel("src/test/resources/plc.owl");
